...
```
This is where you define your context window with the flag ```--latent_length```, the default is 4096 latents context window, which is about 2:55 minutes of audio at 48KHz samplerate.
